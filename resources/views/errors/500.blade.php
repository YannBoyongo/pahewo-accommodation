...
@section('message', 'Something went wrong on our end. Our team has been notified and we are working on it. Please try again in a moment.')
...
@section('actions')
    <button onclick="location.reload()" style="display:inline-flex;align-items:center;gap:8px;background:#d43a7b;color:#fff;padding:12px 24px;border-radius:12px;font-size:14px;font-weight:600;border:none;cursor:pointer;transition:opacity .2s;" onmouseover="this.style.opacity='.85'" onmouseout="this.style.opacity='1'">
