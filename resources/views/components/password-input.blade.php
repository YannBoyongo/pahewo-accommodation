...
<div class="relative" x-data="{ show: false }">
    <input
        ...
        @disabled($disabled)
        {{ $attributes->except(['type'])->merge(['class' => 'input-luxe pe-11']) }}
    />
    <button
        type="button"
        @click="show = !show"
        class="absolute inset-y-0 right-0 flex items-center px-3 text-chocolate-500 transition hover:text-chocolate-700"
        tabindex="-1"
